    ...
    <>
      ...
      <section id="artikel" className="py-16 px-4 text-center">
        ...
        <div className="card-grid">
          <div className="card">
            <img className="my-5" src="assets/ai (2).jfif" alt="Apa Itu Artificial Intelligence?" />
          ...
          <div className="card">
            <img className="my-5" src="assets/html.jfif" alt="Mengenal HTML" />
            <div className="card-body my-5">
              <h3>Mengenal HTML</h3>
          ...
          <div className="card">
            <img className="my-5" src="assets/internet.jfif" alt="Bagaimana Internet Bekerja?" />
            <div className="card-body my-5">
          ...
          <div className="card">
            <img className="my-5" src="assets/py.jfif" alt="Mengenal Python lebih dalam" />
            <div className="card-body my-5">
          ...
          <div className="card">
            <img className="my-5" src="assets/java.jfif" alt="JavaScript itu apa sih?" />
            <div className="card-body my-5">
          ...
          <div className="card">
            <img className="my-5" src="assets/dtsains.jfif" alt="Langkah Awal Belajar Data Science" />
            <div className="card-body my-5">
          ...
          <div className="card">
            <img className="my-5" src="assets/cyberinternet.jfif" alt="Keamanan di Dunia Internet" />
            <div className="card-body my-5">
          ...
          <div className="card">
            <img className="my-5" src="assets/algoritma.jfif" alt="Algoritma Dalam Kehidupan Sehari-hari" />
            <div className="card-body my-5">
          ...
          <div className="card">
            <img className="my-5" src="assets/desain.jfif" alt="Desain Grafis" />
            <div className="card-body my-5">
              <h3>Desain Grafis</h3>
          ...
          <div className="card">
            <img className="my-5" src="assets/IOT.jfif" alt="Komponen Utama IoT" />
            <div className="card-body my-5">
          ...
          <div className="card">
            <img className="my-5" src="assets/uiux.jfif" alt="Mengenal UI/UX" />
            <div className="card-body my-5">
          ...
          <div className="card">
            <img className="my-5" src="assets/program.jfif" alt="Jenis Bahasa Pemrograman" />
            <div className="card-body my-5">
          ...
          <div className="card">
            <img className="my-5" src="assets/web.jfif" alt="Perjalanan Website" />
            <div className="card-body my-5">
